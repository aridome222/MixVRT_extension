...
"""
# キーとエンドポイントを設定する
key = "6a0c3dd7bb22424ca197fa0cd222774a"
endpoint = "https://azure-ocr-aridome.cognitiveservices.azure.com/"

# ComputerVisionClientオブジェクトを作成する
...
for box in boxes:
    # インデックスでアクセスする
    x1, y1, x2, y2, x3, y3, x4, y4 = map(int, box)
    # 左上の座標 (x1, y1) と右下の座標 (x3, y3) を渡して矩形を描画
