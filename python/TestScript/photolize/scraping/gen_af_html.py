...
def generate_modified_after_html(diff_file_path):
    # 変更されたセレクタを格納するリスト
    changed_selectors = []
    ...
    for line in modified_lines:
        ...
        if style_tag_index != -1:
            # Insert the CSS after the </style> tag
    ...
    modified_file_path = os.path.join(output_dir, "after_modified.html")
...
generate_modified_after_html(diff_file_path)
...
# after_modified_html, after_modified_html = apply_style_to_changes(after_html, after_html)
