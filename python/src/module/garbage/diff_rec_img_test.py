...
def main():
    ...
    ### 枠づけ ###
    # 二値化
    ret, img1_bin = cv2.threshold(img1_gray, 0, 255, cv2.THRESH_BINARY)
    ret, img2_bin = cv2.threshold(img2_gray, 0, 255, cv2.THRESH_BINARY)
    ...
    output_file_name3 = "contour1.png"
    output_file_name4 = "contour2.png"
    # ファイルパスを作成
